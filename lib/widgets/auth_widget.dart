...
class HaveAccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      TextButton(onPressed: onPressed, child:  Text(actionLabel,style:const TextStyle(color:Colors.purple,fontWeight: FontWeight.bold,fontSize: 20)))
    ],);
  }
}
...
var textFormDecoration = InputDecoration(
                      labelText: 'Email Address',hintText: 'Enter your email address',border:OutlineInputBorder(
...
extension EmailValidator on String{
  bool isValidEmail(){
    return RegExp(r'^[a-zA-Z0-9]+[\-\_\.]*[a-zA-Z0-9][@][a-zA-Z0-9]{2,}[\.]$').hasMatch(this);
  }
}
