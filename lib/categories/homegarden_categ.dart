                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text("homeandgarden",style : TextStyle(fontSize:24,fontWeight:FontWeight.bold,letterSpacing: 1.5)),
                    ),
                    Column(
                      children: [
                        ...
                        child:GridView.count(
                          mainAxisSpacing: 70,
                          crossAxisSpacing: 15,
                          crossAxisCount:3,children:List.generate(homeandgarden.length, (index){
